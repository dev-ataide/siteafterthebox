...
<div className="w-full bg-transparent">
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-1">
        <div className="text-center pb-12">
            <h1 className="font-bold text-3xl md:text-4xl lg:text-5xl font-heading text-title">
                Conheça <span className='text-gradient'> Nosso Time </span> de Desenvolvimento!
            </h1>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6  ">
            <div className="w-full shadow-2xl bg-bgpurpleATB  rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div className="mb-8">
                    <img className="object-center object-cover rounded-full h-36 w-36" src={Guilherme} />
                </div>
                <div className="text-center">
                    <p className="text-xl text-orangeATB font-bold mb-2">Guilherme Ataide</p>
            ...
            <div className="w-full shadow-2xl bg-bgpurpleATB rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div className="text-center">
                    <p className="text-xl text-orangeATB font-bold mb-2">Wallace Michael</p>
            ...
            <div className="w-full shadow-2xl bg-bgpurpleATB rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div className="text-center">
                    <p className="text-xl text-orangeATB font-bold mb-2">Clara Bezerra</p>
            ...
            <div className="w-full shadow-2xl bg-bgpurpleATB rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div className="text-center">
                    <p className="text-xl text-orangeATB font-bold mb-2">Maycon Yuri</p>
            ...
            <div className="w-full shadow-2xl bg-bgpurpleATB rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div className="text-center">
                    <p className="text-xl text-orangeATB font-bold mb-2">Júlio Gabriel</p>
                    <p className="text-base text-gray-400 font-normal">Back-End Developer </p>
                </div>
            </div>
            <div className="w-full shadow-2xl bg-bgpurpleATB rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div className="text-center">
                    <p className="text-xl text-orangeATB font-bold mb-2">Edmundo Simeon</p>
